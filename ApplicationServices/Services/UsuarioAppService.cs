    ...
    public class UsuarioAppService : AppServiceBase<USUARIO>, IUsuarioAppService
    {
        ...
        public Int32 ValidateCreate(USUARIO usuario, USUARIO usuarioLogado, Int32? idAss)
        {
            try
            {
                ...
                usuario.ASSI_CD_ID = idAss.Value;
        ...
        public Int32 ExecuteFilter(Int32? perfilId, String cargo, String nome, String login, String email, Int32? idAss, out List<USUARIO> objeto)
        {
            try
            {
