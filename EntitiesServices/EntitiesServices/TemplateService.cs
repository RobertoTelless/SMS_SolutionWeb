...
namespace ModelServices.EntitiesServices
{
    public class TemplateService : ServiceBase<TEMPLATE>, ITemplateService
    {
        ...
        public Int32 Create(TEMPLATE item, LOG log, Int32? idAss)
        {
        ...
        public Int32 Create(TEMPLATE item, Int32? idAss)
        {
            using (DbContextTransaction transaction = Db.Database.BeginTransaction(IsolationLevel.ReadCommitted))
            {
                try
        ...
        public Int32 Edit(TEMPLATE item, LOG log, Int32? idAss)
        {
            using (DbContextTransaction transaction = Db.Database.BeginTransaction(IsolationLevel.ReadCommitted))
            {
                try
        ...
        public Int32 Edit(TEMPLATE item, Int32? idAss)
        {
            using (DbContextTransaction transaction = Db.Database.BeginTransaction(IsolationLevel.ReadCommitted))
            {
                try
        ...
        public Int32 Delete(TEMPLATE item, LOG log, Int32? idAss)
        {
            using (DbContextTransaction transaction = Db.Database.BeginTransaction(IsolationLevel.ReadCommitted))
            {
                try
